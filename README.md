...
## 懒加载原理
懒加载预览：http://js.jirengu.com/qujop/1/edit?output 
...
## 瀑布流原理
瀑布流预览: http://js.jirengu.com/xuqir/1/edit?output
- 原理：先通过计算出一排能够容纳几列元素，然后寻找各列之中所有元素高度之和的最小者，并将新的元素添加到该列上，然后继续寻找所有列的各元素之和的最小者，继续添加至该列上，如此循环下去，直至所有元素均能够按要求排列为止；
## 实现原理
